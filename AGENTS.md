...
- Commands typically live under a pushbutton folder (example: [`Coordination.tab/3D Views.panel/Scope Boxs to 3D Views.pushbutton/script.py`](Coordination.tab/3D%20Views.panel/Scope%20Boxs%20to%203D%20Views.pushbutton/script.py)).
